...
Watch this video before doing the exercise: https://www.youtube.com/wxatch?v=XgSjoHgy3Rk
...
console.log(i); //0 1 2 3 4 5 6 up to 20
```
...
if (true) {
  ...
  console.log(username, "First"); // Hello World! first
